...
from app.workers.tasks_import import _build_source_record_ref_id, _resolve_source_record_ref_id
...
def test_source_record_ref_id_reuses_existing_ids_on_replay() -> None:
    source_file_id = UUID("299c4966-af7e-4b47-8837-ca383eda1160")
    existing_ref_id = UUID("bc7de4f6-5a4f-4f78-bc72-a5866296d7db")

    assert _resolve_source_record_ref_id(source_file_id, 1, {1: existing_ref_id}) == existing_ref_id
